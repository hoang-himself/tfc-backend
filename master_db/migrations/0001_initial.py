# Generated by Django 3.2.5 on 2021-07-14 08:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='updated')),
        ...
        migrations.AddIndex(
            model_name='customuser',
            index=models.Index(fields=['birth_date'], name='master_db_c_birth_d_91d0d3_idx'),
        ),
        migrations.AddIndex(
            model_name='customuser',
